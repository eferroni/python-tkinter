...
def show():
    messagebox.showinfo("", f"radio_1={radio_1_var.get()}, radio_2={radio_2_var.get()}")
...
radio_2_1 = tk.Radiobutton(window, text="BR", variable=radio_2_var, value=2, command=command_2)
radio_2_1.pack()
radio_2_2 = tk.Radiobutton(window, text="US", variable=radio_2_var, value=1, command=command_2)
radio_2_2.select()
radio_2_2.pack()
